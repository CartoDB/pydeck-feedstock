...
This project was last updated on 2022-10-17 and is preserved for historical reference only.
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pydeck-feedstock/blob/master/LICENSE.txt)

Summary: Widget for deck.gl maps

Development: https://github.com/uber/deck.gl/tree/master/bindings/pydeck

Documentation: https://pydeck.gl
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8991&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pydeck-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pydeck` can be installed with:

```
conda install pydeck
```

It is possible to list all of the versions of `pydeck` available on your platform with:
